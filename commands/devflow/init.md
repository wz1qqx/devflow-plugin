...
<execution_context>
Workspace init: @../../skills/my-dev/init-workspace.md
Feature init:   @../../skills/my-dev/init-feature.md
</execution_context>
...
Execute @../../skills/my-dev/init-workspace.md end-to-end.
...
Execute @../../skills/my-dev/init-feature.md with the feature name.
