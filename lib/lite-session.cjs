...
function handleLiteSession(subcommand, args) {
  ...
  error(`Unknown session subcommand: '${subcommand}'. Use: snapshot, start, record, status, list, lint, archive-plan, archive, supersede-plan, supersede-stale, close, supersede, reopen`);
}
