...
async function initWorkflow(workflowName, args) {
  ...
  const workflowContextMap = {
    // === Team orchestration ===
    'team':         { ...base, ...memoryContext, cluster: clusterCtx, all_clusters: buildClusterSummary(config), build_history: buildHistory, build: featureWithRepos ? (featureWithRepos.build || {}) : {}, deploy: featureWithRepos ? (featureWithRepos.deploy || {}) : {}, build_server: config.build_server || null, benchmark: featureWithRepos ? (featureWithRepos.benchmark || {}) : {}, verify: featureWithRepos ? (featureWithRepos.verify || {}) : {}, knowledge_notes: knowledgeNotes, feature_state: featureState, devlog: config.devlog || {} },
    ...
    'team-build':   { ...base, cluster: clusterCtx, build_history: buildHistory, build: featureWithRepos ? (featureWithRepos.build || {}) : {}, build_server: config.build_server || null, knowledge_notes: knowledgeNotes, devlog: config.devlog || {} },
    'team-deploy':  { ...base, cluster: clusterCtx, all_clusters: buildClusterSummary(config), deploy: featureWithRepos ? (featureWithRepos.deploy || {}) : {}, build_server: config.build_server || null },
    'team-verify':  { ...base, cluster: clusterCtx, build_history: buildHistory, benchmark: featureWithRepos ? (featureWithRepos.benchmark || {}) : {}, verify: featureWithRepos ? (featureWithRepos.verify || {}) : {}, deploy: featureWithRepos ? (featureWithRepos.deploy || {}) : {}, build_server: config.build_server || null, knowledge_notes: knowledgeNotes, devlog: config.devlog || {} },
    'team-vllm-opt': { ...base, cluster: clusterCtx, build_history: buildHistory, benchmark: featureWithRepos ? (featureWithRepos.benchmark || {}) : {}, verify: featureWithRepos ? (featureWithRepos.verify || {}) : {}, deploy: featureWithRepos ? (featureWithRepos.deploy || {}) : {}, knowledge_notes: knowledgeNotes, devlog: config.devlog || {} },
    // Retained independent skills
  ...
  if (!context) {
    output({
      ...
      artifacts: state,
      deploy: featureWithRepos ? (featureWithRepos.deploy || {}) : {},
      build: featureWithRepos ? (featureWithRepos.build || {}) : {},
      benchmark: featureWithRepos ? (featureWithRepos.benchmark || {}) : {},
