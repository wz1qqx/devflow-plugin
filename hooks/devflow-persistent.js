#!/usr/bin/env node
// devflow Persistent Mode — Stop hook
...
//
// State file: $TMPDIR/devflow-persistent-<ppid>.json
...
const STATE_FILE = path.join(os.tmpdir(), `devflow-persistent-${process.ppid}.json`);
